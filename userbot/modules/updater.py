...
async def update(event, repo, ups_rem, ac_br):
    ...
    await event.edit('`**RXE** Berhasil Di Update!`')
    await asyncio.sleep(1)
    await event.edit('`RXE Di Restart....`')
    await asyncio.sleep(1)
...
async def upstream(event):
    ...
    if conf is None and force_update is False:
        changelog_str = f'**UPDATE Terbaru RXE [{ac_br}]:\n\nPERUBAHAN:**\n`{changelog}`'
    ...
    if force_update:
        ...
        await event.edit('`Proses Update RXE, LOADING1`')
        await event.edit('`Proses Update RXE, LOADING2`')
        await event.edit('`Proses Update RXE, LOADING3`')
        await event.edit('`Proses Update RXE, LOADING4`')
    if conf == "now":
