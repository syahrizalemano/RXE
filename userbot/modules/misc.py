...
REPOLINK = (
    ...
    else "https://github.com/syahrizalemano/RXE"
)
# ============================================
...
async def killdabot(event):
    await event.edit("**RXE RESTART**")
    await asyncio.sleep(10)
    await event.delete()
    if BOTLOG:
        await event.client.send_message(
            BOTLOG_CHATID, "#RESTARTBOT \n" "`RXE Telah Di Restart`"
        )
    await bot.disconnect()
...
async def repo_is_here(wannasee):
    ...
    await wannasee.edit(
        "[REPO​](https://github.com/syahrizalemano/RXE)\n"
        "**OWNER​** ⎆ [EZZRA](t.me/ezzraez)\n"
        "**MANAGE**​ ⎆ [RAHKII](t.me/rahkiisyou)\n"
    )
